...
public class ListadoProductos extends javax.swing.JFrame {
     ...
     */
    public ListadoProductos(GestionInventarioDAO gestionInventarioDAO) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ListadoProductos(new GestionInventarioDAO()).setVisible(true));
    }
        ...
        for (GetInventario p : gestionInventarioDAO.listar()) {
